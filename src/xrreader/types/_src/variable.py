...
- ``name`` — canonical short name used across the ecosystem (e.g. ``"sst"``).
...
#
# Output names produced by ``xrtoolz.ocn.operators`` (RelativeVorticity,
...
REGISTRY: dict[str, Variable] = {
    ...
    for v in (
        ...
        # Ocean kinematic diagnostics (xrtoolz.ocn outputs)
        PSI,
        KE,
        EKE,
        SPEED,
