...
wrapper composes with the rest of :mod:`xrreader`.
"""
...
from xrreader._src.aemet.geo import canonical_province, community_for
from xrreader._src.aemet.parsers import (
    format_aemet_datetime,
    parse_aemet_datetime,
    parse_dms,
    parse_spanish_float,
)
from xrreader._src.aemet.schema import (
    DAILY_FIELDS,
...
class AemetSource(DataSource):
    ...
    def _require_key(self) -> str:
        if self.credentials is None:
            raise AemetAuthError(
                ...
                "environment (see xrreader.load_aemet)."
            )
    ...
    def open(
        ...
        **extras: Any,
        ...
        :mod:`~xrreader._src.aemet.catalog` (``aemet_daily``,
