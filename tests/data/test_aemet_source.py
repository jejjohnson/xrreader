...
from xrreader import AemetAuthError, AEMETCredentials, AemetSource
from xrreader._src.aemet.source import AemetRateLimitError
from xrreader.types import TimeRange
...
def test_429_retries_then_raises(source_and_fake, monkeypatch):
    ...
    monkeypatch.setattr("xrreader._src.aemet.source.time.sleep", lambda _s: None)
...
def test_normals_preserves_zero_values():
    ...
    from xrreader._src.aemet.source import _normals_to_dataset
